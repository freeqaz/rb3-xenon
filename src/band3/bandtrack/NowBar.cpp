...
void NowBar::Miss(float param1, int slot) {
    ...
    // Retail RB3-360 constructs a function-local static Symbol here whose value is
    // never read afterwards -- verified on retail bytes: the guard word at
    // 0x82E4BD50 is tested/set, Symbol::Symbol(const char*) is called on the
    // "miss" literal at 0x820EA388, and the resulting Symbol at 0x82E4BD4C is
