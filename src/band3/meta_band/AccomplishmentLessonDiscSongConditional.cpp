...
AccomplishmentLessonDiscSongConditional::AccomplishmentLessonDiscSongConditional(
    ...
    : AccomplishmentDiscSongConditional(arr, i) {
    Configure(arr);
}
...
AccomplishmentType AccomplishmentLessonDiscSongConditional::GetType() const {
    return kAccomplishmentTypeLessonDiscSongConditional;
}
...
bool AccomplishmentLessonDiscSongConditional::CheckConditionsForSong(
