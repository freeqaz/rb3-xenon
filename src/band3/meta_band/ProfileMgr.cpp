...
bool ProfileMgr::GetHasSeenFirstTimeInstruments(const LocalUser *) const {
    // Wii-only: always seen on X360
    return true;
}

void ProfileMgr::SetHasSeenFirstTimeInstruments(const LocalUser *, bool) {
    // Wii-only: no-op on X360
}
