...
public:
    ...
    std::vector<int> mSlotPriorities; // 0x80
    OvershellOverrideFlow mPanelOverrideFlow; // 0x8c
    OvershellActiveStatus mActiveStatus; // 0x90
    bool mSongOptionsRequired; // 0x94
    bool mUseExtendedMicArrows; // 0x95
    bool mAllowsButtonPulse; // 0x96
    std::vector<LocalBandUser *> mQueuedJoinUsers; // 0x98
    SessionMgr *mSessionMgr; // 0xa4
    BandUserMgr *mBandUserMgr; // 0xa8
    BandUser *mPartRestrictedUser; // 0xac
    TrackType mPartRestriction; // 0xb0
    Difficulty mMinimumDifficulty; // 0xb4
    Rand mPartResolver; // 0xb8
