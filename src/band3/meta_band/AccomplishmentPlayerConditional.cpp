...
AccomplishmentPlayerConditional::AccomplishmentPlayerConditional(DataArray *arr, int i)
    : AccomplishmentConditional(arr, i), mLaunchPartDifficultySym("") {
    Configure(arr);
}
...
AccomplishmentType AccomplishmentPlayerConditional::GetType() const {
    return kAccomplishmentTypePlayerConditional;
}
...
bool AccomplishmentPlayerConditional::InqBestProgressValues(
...
bool AccomplishmentPlayerConditional::InqProgressValues(
    BandProfile *profile, int &i1, int &i2
) {
...
bool AccomplishmentPlayerConditional::IsConditionMet(
    BandProfile *profile, const AccomplishmentCondition &cond
) const {
    int i4 = 0;
    int i8 = 0;
