...
FORCE_LOCAL_INLINE bool QuestManager::HasQuestFilter(Symbol s) const { return GetQuestFilter(s); }
...
FORCE_LOCAL_INLINE bool QuestManager::HasFixedSetlist(Symbol s) const { return GetFixedSetlist(s); }
END_FORCE_LOCAL_INLINE
...
FORCE_LOCAL_INLINE bool QuestManager::HasQuest(Symbol s) const { return GetQuest(s); }
END_FORCE_LOCAL_INLINE
