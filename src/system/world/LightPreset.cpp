...
BEGIN_CUSTOM_PROPSYNC(LightPreset::Keyframe)
    ...
    SYNC_PROP(LED_blue, o.mLedBlue)
    SYNC_PROP(LED_green, o.mLedGreen)
    SYNC_PROP(LED_red, o.mLedRed)
    SYNC_PROP(LED_yellow, o.mLedYellow)
    SYNC_PROP(LED_blue_pattern, o.mLedBluePattern)
    SYNC_PROP(LED_green_pattern, o.mLedGreenPattern)
    SYNC_PROP(LED_red_pattern, o.mLedRedPattern)
    SYNC_PROP(LED_yellow_pattern, o.mLedYellowPattern)
    SYNC_PROP(strobe_setting, o.mStrobeSetting)
END_CUSTOM_PROPSYNC
