...
JoypadGuitarController::JoypadGuitarController(
    ...
    : BeatMatchController(user, cfg, lefty), mDisabled(disabled),
      mDpadForNavigation(true), mFretMask(0), mSink(bsink) {
...
JoypadGuitarController::~JoypadGuitarController() { JoypadUnsubscribe(this); }
