...
protected:
    ...
    PaddedJointPos mBestNodeErrors[kMaxNumErrorNodes]; // 0x10, 33*16=0x210, ends at 0x220
    PaddedJointPos mNodeComponentWeights[MoveFrame::kNumHam1Nodes]; // 0x220, 16*16=0x100, ends
                                                                    // at 0x320
