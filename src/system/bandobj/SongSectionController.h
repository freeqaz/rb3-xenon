...
public:
    ...
    ObjPtr<EventTrigger> mActivePool; // 0x10
    ObjPtr<EventTrigger> mPendingPool; // 0x1c
    ObjList<PracticeSectionMapping> mSectionMappings; // 0x28
    ObjPtr<SongSectionController> mMappingsOwner; // 0x34
    ...
    ObjPtr<EventTrigger> mCreateContentForPool; // 0x64
};
