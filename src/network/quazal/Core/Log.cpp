// Quazal NetZ - Core/Log.cpp
// Map-only scaffold. .text extent 0x82AEA8D0-0x82AEAE2C (1372 B, 2 __FILE__-referencing fns)
...
// rb3-Wii oracle SOURCE available: ../rb3/src/network/Platform/Log.cpp
