    ...
    if args.out:
        doc = {
            "_comment": [
                ...
                "Schema matches scripts/symbol_aliases.json['groups'] so this file can be",
                "merged into it verbatim; tools/gen_symbol_alias_map.py consumes it.",
                "NOTE: adding groups here CANNOT change matched_functions -- the report",
                "path hardcodes functionRelocDiffs=None, under which objdiff's reloc_eq",
                "never compares symbol names. Measured delta: 0.",
