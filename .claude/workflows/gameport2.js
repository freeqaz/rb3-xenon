...
// Round 2 spans (game_splits high-conf). NetSession deferred (network/Quazal /Od specifics).
const UNITS = [
  { rel: 'band3/game/TrackerManager.cpp',            start: '0x825CAF54', end: '0x825CB1D4', prim: 11, conf: 0.92 },
  { rel: 'band3/meta_band/SetlistSortByLocation.cpp',start: '0x82502D18', end: '0x82502DC0', prim: 4,  conf: 0.91 },
  { rel: 'band3/tour/Tour.cpp',                      start: '0x825CA5D4', end: '0x825CA654', prim: 2,  conf: 0.97 },
  { rel: 'band3/meta_band/SongUpgradeMgr.cpp',       start: '0x8258FFAC', end: '0x8259000C', prim: 3,  conf: 0.91 },
  { rel: 'band3/bandtrack/NowBar.cpp',               start: '0x82345B90', end: '0x82345BF0', prim: 2,  conf: 0.97 },
  { rel: 'band3/meta_band/InputMgr.cpp',             start: '0x824871F8', end: '0x82487260', prim: 2,  conf: 0.88 },
  { rel: 'band3/meta_band/AccomplishmentGroup.cpp',  start: '0x8243F0C8', end: '0x8243F130', prim: 2,  conf: 0.97 },
  { rel: 'band3/game/DirectInstrument.cpp',          start: '0x826C48F8', end: '0x826C493C', prim: 2,  conf: 0.97 },
]
